...
class ScancodesAgentPlugin extends AgentPlugin
{
  ...
  private function getParallelProcessingParams(Request $request)
  {
    ...
    // Get values from request with validation
